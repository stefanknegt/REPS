...
class LQR_REPS_model:
    ...
    def __init__(self, lr):
        ...
        #These are the trainable weights for the torch policy model.
        ...
        #Initialize the SGD/adam optimizer and set its learning rate.
    ...
    def plot_grid_weights(self):
        """
        Plot a grid with begin_states, actions and the weights
        """
        begin_states, actions = np.mgrid[-2:2.01:0.05, -2:2.01:0.05]
